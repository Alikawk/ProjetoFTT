    ...
    onSuccess: function(data) {
       if (data.hasOwnProperty('status')) {
        ...
        $.each(data, function(key, val){
              ...
              items.push('<div class="card mb-3"> <img class="card-img-top img-responsive" src="'+url+'"> <div class="card-block"> <h4 class="card-title">'+ val.title +'</h4> <p class="card-text">'+ val.description +'</p> <p class="card-text"><small class="text-muted">Projeto FTT Simulacao</small></p> </div> </div>')
        });
